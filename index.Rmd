...
[ScPo Econ](https://github.com/ScPoEcon/scpo_xaringan) template for Sciences Po.

- Which is a fork of
[jvcasillas](https://github.com/jvcasillas/ru_xaringan) template for Rutgers University.

- That is Github as a short story...

- I changed some small things in the CSS.
    1. Used Reed Logos and color scheme
    1. Added a Reed logo in the footer of standard slides.
    
- The template is now here: https://github.com/mansonp/reed_xaringan/. Visit to check out instructions.
...
---
background-image: url("./img/logo/reed-college-lockup-red.png")
...
We can do this with white, .grey[grey], .black[black], .Reedred[red] and .blue[blue]. 
...
```md
![:scale 20%](./img/logo/reed-college-lockup-red.png)
```
...
- We can create section dividers with Reed red and grey by using the `class` call:
...
---
class: title-slide-section-red
<div class="my-footer"><img src="./img/logo/reed-college-griffin-white.svg" style="height: 60px;"/></div> 

# Reed red section divider
...
- note logo matches this color, so you can use the white PNG if you want!

---
class: title-slide-section-grey
<div class="my-footer"><img src="./img/logo/reed-college-griffin-white.svg" style="height: 60px;"/></div> 

# Reed grey section divider
...
|                                                                                                            |                                   |
| :--------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| <a href="mailto:pablo@reed.edu">.Reedred[<i class="fa fa-paper-plane fa-fw"></i>]               | pablo@reed.edu       |
| <a href="https://mansonp.github.io/reed_xaringan/">.Reedred[<i class="fa fa-link fa-fw"></i>] | slides |
| <a href="http://twitter.com/paulonabike">.Reedred[<i class="fa fa-twitter fa-fw"></i>]                          | @PaulOnABike                         |
| <a href="http://github.com/mansonp">.Reedred[<i class="fa fa-github fa-fw"></i>]                          | @mansonp                      |
